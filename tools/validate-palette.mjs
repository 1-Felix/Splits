/* tools/validate-palette.mjs — vendored palette validator (chart-engine 6.3).
 * Source: the dataviz skill's scripts/validate_palette.js, unmodified except
 * for this header and the CLI filename check. Used by test_palette.mjs to
 * validate every theme's series palette and zone ramp against that theme's
 * own surface — palettes are checked by script, never by eye. */
/**
